...
public class MessageApiController implements MessageApi {
    ...
    public ResponseEntity<Void> postMessage(@ApiParam(value = "Message request to the API for posting a message against a user" ,required=true )  @Valid @RequestBody WallPostRequest body) {
